...
import { PromoQuickCreate, PromoToggle } from "../../promotions/promo-widgets";
                ...
                {rows.map((p) => {
                  ...
                  return (
                    <tr key={p.id} className={cn("hover:bg-surface-2", !active && "opacity-60")}>
                      ...
                      <td className="px-4 py-3">
                        <span className={cn("inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium", active ? "bg-ok-soft text-ok" : "bg-surface-2 text-slate-500")}>
