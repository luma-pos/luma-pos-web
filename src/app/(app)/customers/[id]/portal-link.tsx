      ...
      {token ? (
        <>
          ...
          <div className="flex gap-2 mt-2">
            ...
            <button onClick={generate} disabled={busy} className="px-3 py-1.5 rounded-lg border border-slate-300 dark:border-slate-700 text-xs font-medium disabled:opacity-50">
