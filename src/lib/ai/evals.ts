...
export const AI_EVALUATION_CASES: AiEvaluationCase[] = [
  ...
  {
    id: "dangerous-invoice-cancel",
    prompt: "Hủy hóa đơn HD001",
    expectedIntent: "order_action",
    expectedMissingFields: [],
    expectedPreviewType: "order",
    confirmation: "strong",
    shouldFallback: false,
    tags: ["dangerous", "invoice", "cancel"],
  },
  {
    id: "dangerous-einvoice",
    prompt: "Gửi hóa đơn điện tử cho HD001",
    expectedIntent: "order_action",
    expectedMissingFields: [],
    expectedPreviewType: "order",
    confirmation: "strong",
    shouldFallback: false,
    tags: ["dangerous", "einvoice"],
  },
  {
